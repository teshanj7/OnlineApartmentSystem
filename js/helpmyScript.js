function loadData(name){
    if(name=="btn1")
    {
        ...
        document.getElementById("imageHelp").src = "../images/FAQGeneral.png";
    }
    ...
    else if(name=="btn2")
    {
        ...
        document.getElementById("imageHelp").src = "../images/FAQUser.png";
    }
    ...
    else if(name=="btn3")
    {
        ...
        document.getElementById("imageHelp").src = "../images/FAQCustomer.png";
    }
    ...
    else if(name=="btn4")
    {
        ...
        document.getElementById("imageHelp").src = "../images/FAQSeller.png";
    }
    ...
    else if(name=="btn5")
    {
        ...
        document.getElementById("imageHelp").src = "../images/FAQOther.png";
    }
}